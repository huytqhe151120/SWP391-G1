...
<form id="accountForm" class="account-form" method="post" action="${pageContext.request.contextPath}/accounts/create">
    ...
    <div class="form-actions">
        ...
        <a class="button-secondary" href="${pageContext.request.contextPath}/accounts">Cancel</a>
    </div>
</form>
